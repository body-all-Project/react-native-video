...
// setStickerList = () => {
//   if(!this.props.stickerList) return [];
//   const stickerList = [];
//   for (const stickerData of this.props.stickerList) {
//     const sticker = resolveAssetSource(stickerData) || {}
//     const shouldCache = !sticker.__packager_asset;
//
//     let uri = sticker.uri || '';
//     if (uri && uri.match(/^\//)) {
//       uri = `file://${uri}`;
...
//       shouldCache,
//       type: sticker.type || '',
//       mainVer: sticker.mainVer || 0,
//       patchVer: sticker.patchVer || 0,
//       requestHeaders: sticker.headers ? this.stringsOnlyObject(sticker.headers) : {},
//     })
//   }
//
//   return stickerList;
